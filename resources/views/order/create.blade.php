            ...
            <form method="POST" id="create-pharmacy-form" enctype="multipart/form-data"
                ...
                <div class="modal-body row gy-2 gx-3 align-items-center">
                    <div class="col-md-12 mb-2">
                        <label for="orderUser" class="form-label">Bệnh nhân</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="medicine_id[]" id="medicine-select" class="select2 " multiple="multiple"
                            data-placeholder="Chọn loại thuốc" data-dropdown-css-class="select2-purple"
                            style="width: 100%;">
                            <option></option>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="createPharmacyName" class="form-label">Nhà thuốc</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="createDoctorName" class="form-label">Bác sĩ kê</label>
                    ...
                    <div class="col-md-12 mb-2">
                        <label for="createOrderCreator" class="form-label">Người tạo</label>
                        @if (auth()->user()->hasRole('admin'))
                            <select name="creator_type" id="createOrderCreator" class="form-control">
                                <option value="client">Bác sĩ</option>
                                <option value="doctor">Dược sĩ</option>
                            </select>
                        @endif
                        @if (auth()->user()->hasRole('pharmacy'))
