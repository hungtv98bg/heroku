    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cập nhật nhà thuốc</h5>
            ...
            <form method="POST" id="edit-pharmacy-form" enctype="multipart/form-data">
                ...
                <div class="modal-body row gy-2 gx-3 align-items-center">
                    <div class="col-md-12 mb-2">
                        <label for="PharmacyName" class="form-label">Tên nhà thuốc</label>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input name="nguoiquanly" class="form-control" id="nguoiquanly" value="">
                    </div>
                    <div class="col-md-6 mb-2">
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="priority" class="form-label">Giấy phép hoạt động</label>
