...
class PharmaciesDataTable extends DataTable
{
    ...
    */
    ...
    {
        return [
            Column::make('id')->addClass('text-center')->addClass('align-middle')->title('STT'),
            Column::computed('avatar')->addClass('text-center')->addClass('align-middle')->title('Hình ảnh'),
            Column::make('pharmacy_name')->addClass('text-center')->addClass('align-middle')->title('Tên nhà thuốc'),
            Column::make('nguoiquanly')->addClass('text-center')->addClass('align-middle')->title('Người quản lý'),
            Column::computed('Owner Name')->addClass('text-center')->addClass('align-middle')->title('Số điện thoại'),
            Column::computed('Owner Email')->addClass('text-center')->addClass('align-middle')->title('Email'),
            Column::computed('Area')->addClass('text-center')->addClass('align-middle')->title('Khu vực'),
            Column::make('priority')->addClass('text-center')->addClass('align-middle')->title('Giấy phép kinh doanh'),
