...
class MedicinesDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        $columns = [
            ...
            Column::make('name')->title('Medicine Name')->addClass('text-center')->addClass('align-middle')->title('Tên thuốc'),
            Column::make('type')->addClass('text-center')->addClass('align-middle')->title('Loại thuốc'),
            Column::computed('quantity')->addClass('text-center')->addClass('align-middle')->title('Số lượng'),
            Column::computed('Price')->addClass('text-center')->addClass('align-middle')->title('Giá')
        ];
        if (auth()->user()->hasRole('admin')) {
