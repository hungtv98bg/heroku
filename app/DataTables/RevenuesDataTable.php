...
class RevenuesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('Total Revenue', function (Pharmacy $pharmacy) {
            return DB::table('orders')->where('pharmacy_id',$pharmacy->id)
                                             ->where('status','Delivered')->sum('price') . ' VNĐ';
        })
        ->rawColumns(['Avatar'])
        ->setRowId('id');
    }
    ...
    public function getColumns()
    {
        return [
                    ...
                    Column::computed('Pharmacy Name')->addClass('text-center')->addClass('align-middle')->title('Tên nhà thuốc'),
                    Column::computed('Total Orders')->addClass('text-center')->addClass('align-middle')->title('Số lượng'),
                    Column::computed('Total Revenue')->addClass('text-center')->addClass('align-middle')->title('Doanh thu')
                ];
    }
