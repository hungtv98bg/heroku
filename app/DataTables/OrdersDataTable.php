...
->setRowId('id');
    ...
    public function getColumns(): array
    {
        $columns = [
            ...
            Column::computed('name')->title('client Name')->title('Bệnh nhân'),
            Column::make('status')->addClass('text-center')->addClass('align-middle')->title('Địa chỉ'),
            Column::computed('is_insured')->addClass('text-center')->addClass('align-middle')->title('Thuốc'),
            Column::computed('doctor_id')->title('Số lượng'),
            Column::make('price')->addClass('text-center')->addClass('align-middle')->title('Bác sĩ khám'),
        ];
        if (Auth::user()->hasRole('admin')) {
            $columns = array_merge($columns, [
                Column::make('creator_type')->title('Người tạo đơn')->addClass('text-center')->addClass('align-middle'),
                Column::computed('Pharmacy')->addClass('text-center')->addClass('align-middle')->title('Nhà thuốc'),
            ]);
        }
