...
class ClientsDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('id', 'National ID')->addClass('text-center')->addClass('align-middle')->title('Họ và tên'),
            Column::computed('name', 'Name')->addClass('text-center')->addClass('align-middle')->title('Tuổi'),
            Column::computed('email', 'Email')->addClass('text-center')->addClass('align-middle')->title('Số điện thoại'),
            Column::make('phone')->addClass('text-center')->addClass('align-middle')->title('Giới tính'),
            Column::computed('Gender')->addClass('text-center')->addClass('align-middle')->title('Địa chỉ'),
