...
class AreasDataTable extends DataTable
{
    ...
    {
        return [
            Column::make('id')->addClass('text-center')->addClass('align-middle')->title('Mã lịch hẹn'),
            Column::computed('Country')->addClass('text-center')->addClass('align-middle')->title('Bác sĩ'),
            Column::make('name')->addClass('text-center')->addClass('align-middle')->title('Bệnh nhân'),
            Column::make('address')->addClass('text-center')->addClass('align-middle')->title('Thời gian'),
